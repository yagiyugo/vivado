...
#ifndef __lenet5_ap2_dcmp_6bkb__HH__
#define __lenet5_ap2_dcmp_6bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet5_ap2_dcmp_6bkb) {
    ...
    SC_CTOR(lenet5_ap2_dcmp_6bkb):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
