...
#ifndef __lenet5_ap2_mac_mudEe__HH__
#define __lenet5_ap2_mac_mudEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet5_ap2_mac_mudEe) {
    ...
    SC_CTOR(lenet5_ap2_mac_mudEe):  simcore_mac_0_U ("simcore_mac_0_U") {
