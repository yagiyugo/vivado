...
#ifndef __lenet5_ap2_sitodpcud__HH__
#define __lenet5_ap2_sitodpcud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet5_ap2_sitodpcud) {
    ...
    SC_CTOR(lenet5_ap2_sitodpcud):  ACMP_sitodp_U ("ACMP_sitodp_U") {
