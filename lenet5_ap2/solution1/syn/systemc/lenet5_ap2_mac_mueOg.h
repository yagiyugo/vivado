...
#ifndef __lenet5_ap2_mac_mueOg__HH__
#define __lenet5_ap2_mac_mueOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet5_ap2_mac_mueOg) {
    ...
    SC_CTOR(lenet5_ap2_mac_mueOg):  simcore_mac_0_U ("simcore_mac_0_U") {
